Vagrant.configure("2") do |config|
  ...
  config.vm.define "master" do |subconfig|
    ...
    subconfig.dns.patterns = "rxtvap1010.k8s.test", "k8scp", "salt"
  ...
  #  harbor.vm.network "private_network", ip: "10.10.10.100"
  #  harbor.vm.hostname = "rxtvap1100"
  #end
  ...
  config.vm.define "worker1" do |subconfig|
    ...
    subconfig.dns.patterns = "rxtvap1011.k8s.test"
  end
  ...
  config.vm.define "worker2" do |subconfig|
    ...
    subconfig.dns.patterns = "rxtvap1012.k8s.test"
  end
  ...
  config.vm.define "etcd1" do |subconfig|
    ...
    subconfig.dns.patterns = "rxtvap1021.k8s.test"
  end
  ...
  config.vm.define "etcd2" do |subconfig|
    ...
    subconfig.dns.patterns = "rxtvap1022.k8s.test"
  end
  ...
  config.vm.define "etcd3" do |subconfig|
    ...
    subconfig.dns.patterns = "rxtvap1023.k8s.test"
  end
end
